...
export const PreferenceToggles = (props: PreferenceTogglesProps) => {
    ...
    return (
        <div className="flex flex-row h-max w-full justify-evenly">
            {props.togglesToDisplay.screenMode && (
                <div className="shadow-light-around dark:shadow-dark-around bg-primaryLight dark:bg-secondaryDark p-0.5 rounded-xl w-max cursor-pointer">
            ...
            {props.togglesToDisplay.language && (
                <div className="bg-primaryLight dark:bg-secondaryDark shadow-light-around dark:shadow-dark-around p-0.5 rounded-xl w-max cursor-pointer">
            ...
            props.togglesToDisplay.profile ? (
                <div className="flex flex-row space-x-4 bg-primaryLight dark:bg-secondaryDark shadow-light-around dark:shadow-dark-around px-2 rounded-xl">
                    {props.togglesToDisplay.logout && (
                        <button
